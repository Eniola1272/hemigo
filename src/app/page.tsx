...
export const metadata: Metadata = {
  title: "Commerce for launches, shops and events",
  description: "Sell products, preorders, services and tickets with a Hemigo storefront, Paystack payments, invoices and organised fulfillment.",
